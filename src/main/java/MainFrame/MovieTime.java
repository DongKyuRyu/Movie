...
public class MovieTime extends WindowAdapter implements ActionListener, ItemListener {
	...
	public String getChoiceTime() {
		String sum = calendarex.getChoiceDay() + "/" + Choicetime;
		return sum;
	}
	...
	public void itemStateChanged(ItemEvent e) {
		...
		if (e.getItem().equals("12:00 ~ 14:20") || e.getItem().equals("14:30 ~ 16:50")
				|| e.getItem().equals("17:00 ~ 19:20")) {
...
//			CalendarEx calendarex = new CalendarEx("이 전", this);
		...
		if (e.getActionCommand().equals("다 음")) {
			f.setVisible(false);
			System.out.println(getChoiceTime());
