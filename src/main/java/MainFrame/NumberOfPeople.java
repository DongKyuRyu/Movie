				...
				Seat[i][j].addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if (Seat[finalI][finalJ].equals(Seat[0][finalJ])
								|| Seat[finalI][finalJ].equals(Seat[1][finalJ])) {
...
//			ticketDao.connect();
//			String seatnumber = ticketDao.selectSeat(moviedata.getMovieList(), moviedata.getMovieDate(), moviedata.getMovieTime());
//			moviedata.setDuplicateSeat(seatnumber);
