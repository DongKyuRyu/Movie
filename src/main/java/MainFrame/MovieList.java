...
public class MovieList implements ActionListener, ItemListener, WindowListener {
	private Frame f;
	private Checkbox selectMovie1, selectMovie2, selectMovie3, selectMovie4, selectMovie5, selectMovie6, selectMovie7,
			selectMovie8, selectMovie9, selectMovie10, selectMovie11, selectMovie12;
	...
	public void itemStateChanged(ItemEvent e) {
		...
		if (e.getItem().equals("그대들은 어떻게 살 것인가") || e.getItem().equals("플라워 킬링 문") || e.getItem().equals("빌리와 용감한 녀석들")
