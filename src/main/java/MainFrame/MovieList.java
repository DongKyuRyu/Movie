...
public class MovieList extends WindowAdapter implements ActionListener, ItemListener {
	...
	private String ChoiceMovieName;
	// test-----------------------------------------------------------------------


	// test-----------------------------------------------------------------------
	public void setChoiceMovieName(String ChoiceMovieName) {
		this.ChoiceMovieName = ChoiceMovieName;
	}

	public String getChoiceMovieName() {
		return ChoiceMovieName;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals("다 음")) {
			...
			CalendarEx Calendarex = new CalendarEx("다음", this);
		}
	}

	public void itemStateChanged(ItemEvent e) {
		if (e.getItem().equals("30일"))
			setChoiceMovieName("30일");
		if (e.getItem().equals("용감한 시민"))
			setChoiceMovieName("용감한 시민");
		if (e.getItem().equals("천박사"))
			setChoiceMovieName("천박사");
